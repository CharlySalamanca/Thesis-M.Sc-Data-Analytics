...
non_numeric_values <- c(rep("ungültig", 50), rep("error", 50), rep("unbekannt", 50))
faulty_values <- c(extreme_values, non_numeric_values)
...
na_rows <- which(is.na(df.fcar$jahre_im_unternehmen))
